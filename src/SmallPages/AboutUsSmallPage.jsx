        ...
        <div className="aboutUsCards--Container">
          <div className="aboutUsCards">
            ...
            <div className="aboutUsCard--Body">
              <p>
                ...
                accurate, timely, and cost-effective. Ultimately, our vision is
                to make bookkeeping services more accessible, approachable, and
          ...
          <div className="aboutUsCards">
            <div className="aboutUsCards--Header">
              ...
              <div className="aboutUsCard--Body">
                <p>
                  Our purpose is to accurately maintain financial data and
                  provide organized reports for business owners, ensuring
                  compliance with legal requirements and aiding in informed
                  decision-making.
                </p>
              </div>
            </div>
          ...
          <div className="aboutUsCards">
            ...
            <div className="aboutUsCard--Body">
              <p>
                ...
                organized, enabling them to focus on growing their businesses
